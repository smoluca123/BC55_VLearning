        ...
        <div className="flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          ...
          <div className="flex gap-4 text-blue-gray-900 sm:justify-center text-[30px]">
            <Typography
              as="a"
              href="#"
              className="flex items-center justify-center opacity-80 transition-opacity hover:opacity-100  text-[30px] border border-solid border-[#41b294] rounded-full p-2 bg-[#41b294] text-white"
            >
              <svg
                className="h-5 w-5 "
                fill="currentColor"
